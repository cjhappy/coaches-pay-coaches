...
export default function Purchases() {
  ...
  return (
    <div className="page-body cream-page">
      <SiteNav active="purchases" />

      <div className="dash-header">
        <div className="section-label">My Library</div>
        <h1>Your <em>Purchases</em></h1>
        <p>All your purchased coaching materials in one place.</p>
      </div>
      ...
      <div className="dash-body">
        ...
        {loading ? (
          ...
          <div className="cpc-card" style={{ padding: '3rem', textAlign: 'center' }}>
            ...
            <p className="muted" style={{ marginBottom: '1.5rem', fontSize: '1.05rem' }}>You haven't purchased anything yet.</p>
              ...
              <div key={purchase.id} className="cpc-card" style={{ padding: '1.25rem', display: 'flex', alignItems: 'center', gap: '1.25rem', flexWrap: 'wrap' }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
                    <div style={{ fontFamily: 'var(--font-sub)', fontWeight: 700, fontSize: '1.05rem', textTransform: 'uppercase', color: 'var(--navy)' }}>
                      {getTitle(purchase)}
                    </div>
                    {!purchase.listings && (
                      <span className="muted" style={{ fontSize: '10px', border: '1px solid var(--border-on-cream)', padding: '2px 6px', borderRadius: '100px' }}>Removed</span>
                    )}
                  </div>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', flexShrink: 0 }}>
                  <div style={{ color: 'var(--navy)', background: 'var(--yellow)', padding: '2px 10px', borderRadius: '5px', fontFamily: 'var(--font-sub)', fontWeight: 800, fontSize: '1rem' }}>
