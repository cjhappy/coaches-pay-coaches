  ...
  return (
    <div className="page-body cream-page">
      ...
      <div className="dash-body" style={{ maxWidth: '720px' }}>
        ...
        <div className="cpc-card" style={{ padding: '1.75rem', marginBottom: '1.5rem', borderColor: '#b91c1c', background: 'rgba(185,28,28,0.05)' }}>
          <div style={{ fontFamily: 'var(--font-sub)', fontWeight: 700, fontSize: '1.1rem', textTransform: 'uppercase', color: '#b91c1c', marginBottom: '8px' }}>All Sales Are Final</div>
        ...
        <div className="cpc-card" style={{ padding: '1.75rem', marginBottom: '1.5rem' }}>
          <div style={{ color: 'var(--navy)', fontFamily: 'var(--font-sub)', fontWeight: 700, fontSize: '1rem', textTransform: 'uppercase', marginBottom: '12px' }}>Why We Have This Policy</div>
          <p style={{ color: 'var(--navy)', fontSize: '.92rem', lineHeight: 1.7, marginBottom: '12px' }}>
        ...
        <div className="cpc-card" style={{ padding: '1.75rem', marginBottom: '1.5rem' }}>
          <div style={{ color: 'var(--navy)', fontFamily: 'var(--font-sub)', fontWeight: 700, fontSize: '1rem', textTransform: 'uppercase', marginBottom: '12px' }}>What This Policy Covers</div>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
            {[
              ...
              <div key={i} style={{ display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
                <span style={{ color: '#b91c1c', fontWeight: 700, flexShrink: 0, marginTop: '2px' }}>×</span>
                <span style={{ color: 'var(--navy)', fontSize: '.9rem', lineHeight: 1.6 }}>{item}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="cpc-card" style={{ padding: '1.75rem', marginBottom: '1.5rem' }}>
          <div style={{ color: 'var(--navy)', fontFamily: 'var(--font-sub)', fontWeight: 700, fontSize: '1rem', textTransform: 'uppercase', marginBottom: '12px' }}>Exceptions</div>
          <p style={{ color: 'var(--navy)', fontSize: '.92rem', lineHeight: 1.7, marginBottom: '12px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
            {[
              ...
              <div key={i} style={{ display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
                <span style={{ color: '#1a7a3e', fontWeight: 700, flexShrink: 0, marginTop: '2px' }}>✓</span>
                <span style={{ color: 'var(--navy)', fontSize: '.9rem', lineHeight: 1.6 }}>{item}</span>
              </div>
            ))}
          </div>
        ...
        <div className="cpc-card" style={{ padding: '1.75rem', marginBottom: '1.5rem' }}>
          <div style={{ color: 'var(--navy)', fontFamily: 'var(--font-sub)', fontWeight: 700, fontSize: '1rem', textTransform: 'uppercase', marginBottom: '12px' }}>Chargebacks</div>
          <p style={{ color: 'var(--navy)', fontSize: '.92rem', lineHeight: 1.7, marginBottom: '12px' }}>
        ...
        <p className="muted" style={{ fontSize: '.8rem', textAlign: 'center', marginTop: '2rem' }}>
